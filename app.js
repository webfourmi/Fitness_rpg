...
const sports = [
  { id: "warmup", icon: "🔥", title: "Échauffement", description: "Mobilité douce pour préparer la séance.", options: [
    { id: "warmup", label: "5 min", description: "5 min de mobilité douce", xp: 10, stat: "Discipline", pose: "warmup" },
  ]},
  { id: "walk", icon: "🚶", title: "Marche active", description: "Dehors ou sur tapis.", options: [
    { id: "walk", label: "30 min", description: "30 min dehors ou tapis", xp: 35, stat: "Endurance", pose: "walk" },
  ]},
  { id: "bike", icon: "🚴", title: "Vélo", description: "Intérieur ou extérieur, rythme confortable.", options: [
  ...
  { id: "pilates", icon: "🧘", title: "Pilates", description: "Renforcement doux, posture et stabilité.", options: [
  ...
  { id: "strength", icon: "💪", title: "Renforcement", description: "Pompes, mountain climbing, squats et gainage.", options: [
  ...
  { id: "musculation", icon: "🏋️", title: "Musculation", description: "Séance complète de musculation.", options: [
  ...
  { id: "stretch", icon: "🌿", title: "Étirements", description: "Récupération et souplesse.", options: [
...
const strengthQuestIds = ["pushups10", "pushups15", "pushups20", "pushups25", "pushups30", "mountain60", "mountain80", "mountain100", "squats10", "squats20", "squats30", "squats40", "core", "muscu30", "muscu45"];
...
const coaches = {
  korvan: {
    ...
    byQuest: {
      warmup: ["Échauffe-toi. Même une hache doit être levée avant la bataille."], walk: ["Marche. Chaque pas écrase un peu plus l’ancien toi."], bike15: ["Quinze minutes de roue. C’est assez pour réveiller le souffle."], bike: ["Pédale. Que tes jambes deviennent des roues de guerre."],
      pilates10: ["Dix minutes de contrôle. Même un barbare doit tenir son centre."], pilates30: ["Trente minutes de discipline lente. Voilà une force qui ne crie pas."], pilates45: ["Quarante-cinq minutes. Ton tronc devient une forteresse."],
      pushups10: ["Dix pompes. Le sol a pris le premier avertissement."], pushups15: ["Quinze pompes. Les bras commencent à parler fort."], pushups20: ["Vingt pompes. Voilà une offrande correcte à la forge."], pushups25: ["Vingt-cinq pompes. La faiblesse change de trottoir."], pushups30: ["Trente pompes. Les épaules entrent dans la saga."],
      mountain60: ["Soixante mountain climbers. La montagne n’a qu’à bien se tenir."], mountain80: ["Quatre-vingts. Le souffle grogne, mais il suit."], mountain100: ["Cent mountain climbers. Voilà une avalanche disciplinée."],
      squats10: ["Dix squats. Le sol doit comprendre qui commande."], squats20: ["Vingt squats. Les jambes forgent leur réputation."], squats30: ["Trente squats. La gravité commence à perdre patience."], squats40: ["Quarante squats. Les jambes entrent dans la légende."],
      muscu30: ["Trente minutes de musculation. La forge a bien chauffé."], muscu45: ["Quarante-cinq minutes de musculation. Voilà du métal solide."], core: ["Tiens. Un tronc solide porte mieux la légende."], stretch: ["La récupération n’est pas une faiblesse. C’est l’affûtage de la lame."],
    },
  },
  xara: {
    name: "Xara",
    ...
    byQuest: {
      warmup: ["Une bonne guerrière ne charge pas à froid."], walk: ["Garde l’allure. La régularité gagne plus de combats que l’orgueil."], bike15: ["Quinze minutes bien tenues. C’est un vrai tour de chauffe."], bike: ["Trouve ton rythme. Respiration stable, jambes efficaces."],
      pilates10: ["Contrôle court, utile et précis. Très bon choix."], pilates30: ["Trente minutes de maîtrise. Le corps devient plus fiable."], pilates45: ["Longue séance, belle discipline. Tu as tenu la ligne."],
      pushups10: ["Dix pompes nettes. La posture d’abord, la force ensuite."], pushups15: ["Quinze pompes. Garde la ligne, gagne le combat."], pushups20: ["Vingt pompes. Appuis solides, souffle contrôlé."], pushups25: ["Vingt-cinq pompes. C’est là que la discipline parle."], pushups30: ["Trente pompes. Travail sérieux, résultat sérieux."],
      mountain60: ["Soixante mountain climbers. Rythme propre, bassin stable."], mountain80: ["Quatre-vingts. Tu tiens la cadence."], mountain100: ["Cent mountain climbers. Très belle endurance."],
      squats10: ["Dix squats. Appuis propres, mouvement utile."], squats20: ["Vingt squats. Les jambes construisent la victoire."], squats30: ["Trente squats. Continue, c’est solide."], squats40: ["Quarante squats. Excellent travail de base."],
      muscu30: ["Trente minutes de musculation. Séance carrée."], muscu45: ["Quarante-cinq minutes. Discipline longue, progrès réel."], core: ["Tiens la position. Le combat se gagne aussi dans l’immobilité."], stretch: ["Récupère avec sérieux. La souplesse protège le guerrier."],
    },
  },
  violette: {
    ...
    byQuest: { warmup: ["On réveille doucement la machine."], walk: ["Une bonne marche, c’est une aventure qui a mis de bonnes chaussures."], bike15: ["Petite sortie vélo, joli pactole d’XP !"], bike: ["Tes jambes tournent, ton XP monte. Belle affaire !"], pilates10: ["Dix minutes bien placées. Petit effort, vrai progrès."], pilates30: ["Trente minutes de Pilates, ça mérite une médaille moelleuse."], pilates45: ["Quarante-cinq minutes ! Là, le coussin applaudit."], stretch: ["On s’étire, on respire, on remet le corps en mode velours."] },
  },
  elmin: {
    ...
    byQuest: { warmup: ["Le rituel commence par la préparation."], walk: ["La marche est une magie ancienne : simple, lente, efficace."], bike15: ["Un cycle court, mais utile. L’endurance se nourrit aussi de régularité."], bike: ["Pédale avec méthode. Le souffle est ton métronome."], pilates10: ["Dix minutes de précision. Le centre s’éveille."], pilates30: ["Trente minutes de contrôle. La posture gagne en pouvoir."], pilates45: ["Quarante-cinq minutes de concentration. Le sort tient."], stretch: ["La souplesse est une magie lente. Ne la brusque pas."] },
  },
};
...
function summaries(){const completed=doneToday(),lastQuest=quests.find(quest=>quest.id===completed.at(-1));el.questSummary.textContent=lastQuest?`Dernière quête : ${lastQuest.sportTitle} · ${lastQuest.label}`:"Aucune quête validée aujourd’hui.";el.musicSummary.textContent=musicStatus}
